...
setup(name='cytometer',
      ...
      install_requires=['keras>=2.2.4',
                        ...
                        'receptivefield>=0.4.0', 'pysto>=1.4.1', 'seaborn>=0.10.0',
                        'mahotas>=1.4.4', 'networkx>=2.1', 'statsmodels>=0.9.0', 'statannot>=0.2.3',
                        'mlxtend>=0.17.0', 'shapely>=1.6.4.post2', 'ujson>=1.35']
      )
