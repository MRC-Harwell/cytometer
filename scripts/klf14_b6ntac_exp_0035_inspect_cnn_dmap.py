...
saved_model_basename = 'klf14_b6ntac_exp_0035_cnn_dmap'  # dmap regression model
...
saved_model_kfold_filename = os.path.join(saved_models_dir, 'klf14_b6ntac_exp_0034_cnn_contour_info.pickle')
