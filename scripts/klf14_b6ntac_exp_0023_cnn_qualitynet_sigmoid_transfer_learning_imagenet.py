...
for i_fold, idx_test in enumerate([idx_orig_test_all[0]]):
    ...
    with tf.device('/cpu:0'):
        ...
        # output
        imagenet_weights_file = os.path.join(saved_models_dir, 'densenet121_weights_tf_dim_ordering_tf_kernels_notop.h5')
        base_model = DenseNet(blocks=[6, 12, 24, 16], include_top=False,
                              weights=imagenet_weights_file,
