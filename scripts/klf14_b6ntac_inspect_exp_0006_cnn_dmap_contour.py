...
saved_model_basename = 'klf14_b6ntac_exp_0006_cnn_contour'  # dmap + contour, classification loss weight 1000, hard_sigmoid for classification
...
contour_test_pred = model.predict(im_test[i, :, :, :].reshape((1,) + im_test.shape[1:]))
