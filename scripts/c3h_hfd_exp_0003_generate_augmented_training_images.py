"""
scripts/c3h_hfd_exp_0003_generate_augmented_training_images.py

Script to generate augmented training data for the c3h_hfd experiments.
...
This script creates dmap, im, mask, contour and lab in c3h_hfd_training_augmented.
"""
...
# data paths
root_data_dir = os.path.join(home, 'Data/cytometer_data/c3h')
training_dir = os.path.join(root_data_dir, 'c3h_hfd_training')
training_non_overlap_data_dir = os.path.join(root_data_dir, 'c3h_hfd_training_non_overlap')
training_augmented_dir = os.path.join(root_data_dir, 'c3h_hfd_training_augmented')
