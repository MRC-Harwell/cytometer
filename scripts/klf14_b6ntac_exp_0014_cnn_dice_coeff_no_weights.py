"""
Training of CNN for regression of Dice coefficients, using the whole loss function, without element-wise weighting. This
way, everything we didn't segment manually will have a Dice coeff = 0.0.
"""
