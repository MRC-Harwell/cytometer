...
merge_f_l.boxplot(column='area', by='training/test', ax=ax, showfliers=False, notch=True)
ax.set_ylim(0, 2e4)
ax.set_title('female lfd', fontsize=25)
ax.set_xlabel('')
ax.set_ylabel('area (um^2)', fontsize=21)
plt.tick_params(axis='both', which='major', labelsize=22)
ax = plt.subplot(121)
merge_f_h.boxplot(column='area', by='training/test', ax=ax, showfliers=False, notch=True)
ax.set_ylim(0, 2e4)
ax.set_title('female hfd', fontsize=25)
ax.set_xlabel('')
ax.set_ylabel('area (um^2)', fontsize=21)
plt.tick_params(axis='both', which='major', labelsize=22)
...
ax.set_ylim(0, 1.5e4)
ax.set_title('male lfd', fontsize=25)
ax.set_xlabel('')
ax.set_ylabel('area (um^2)', fontsize=21)
plt.tick_params(axis='both', which='major', labelsize=22)
ax = plt.subplot(121)
...
ax.set_ylim(0, 1.5e4)
ax.set_title('male hfd', fontsize=25)
ax.set_xlabel('')
ax.set_ylabel('area (um^2)', fontsize=21)
plt.tick_params(axis='both', which='major', labelsize=22)