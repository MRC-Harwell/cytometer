"""
Processing full slides with Fold 0 of pipeline v3:
...
experiment_id = 'klf14_b6ntac_exp_0065_full_slide_processing'

# model names
saved_contour_model_basename = 'klf14_b6ntac_exp_0070_cnn_contour_after_dmap'
saved_dmap_model_basename = 'klf14_b6ntac_exp_0056_cnn_dmap'
saved_classifier_model_basename = 'klf14_b6ntac_exp_0061_cnn_tissue_classifier_fcn_overlapping_scaled_contours'
saved_correction_model_basename = 'klf14_b6ntac_exp_0053_cnn_quality_network_fcn_overlapping_scaled_contours'

saved_contour_model_basename += '_model'
saved_dmap_model_basename += '_model'
saved_classifier_model_basename += '_model'
saved_correction_model_basename += '_model'
...
for i_file, file in enumerate(files_list):
    ...
    annotations_file = os.path.join(annotations_dir, annotations_file + '_exp_0073.json')

    # name of file to save areas and contours
    results_file = os.path.basename(file)
    results_file = os.path.splitext(results_file)[0]
    results_file = os.path.join(results_dir, results_file + '_exp_0073.npz')
