"""
Segmentation Correction Network. (All data, no folds).
...
experiment_id = 'klf14_b6ntac_exp_0104_cnn_segmentation_correction_overlapping_scaled_contours'
...
'''Load folds (we are not going to use them, but still want the list of files)'''
...
saved_logs_dir = os.path.join(saved_models_dir, experiment_id + '_logs_fold')
...
# shuffle indices
idx_train = np.array(range(len(file_svg_list)))
