"""
Contour segmentation of dmaps for all folds using focal loss.
...
contour_model_basename = 'klf14_b6ntac_exp_0071_cnn_contour_after_dmap'

# experiment we are inspecting
experiment_id = 'klf14_b6ntac_exp_0071_cnn_contour_after_dmap'
