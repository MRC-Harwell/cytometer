"""
This script aggregates all the cells in each '*_exp_0097_[auto | corrected].json' file and saves them to a
'*_exp_0097_[auto | corrected]_aggregate.json', then creates a soft links to it that will be read by AIDA.
"""
...
def process_annotations(annotation_files_list, overwrite_aggregated_annotation_file=False, create_symlink=False):
    ...
    for i, annotation_file in enumerate(annotation_files_list):
        ...
        print(str(i) + ': File: ' + os.path.basename(annotation_file))
