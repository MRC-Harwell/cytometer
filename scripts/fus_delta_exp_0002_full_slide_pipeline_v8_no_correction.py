"""
Processing full slides of Silvia Corrochano's FUS-DELTA-DBA-B6-IC with pipeline v8, without segmentation correction:
...
for i_file, ndpi_file in enumerate(ndpi_files_list):
    ...
    annotations_file = os.path.join(annotations_dir, annotations_file + '_exp_0002_auto.json')
    ...
    annotations_corrected_file = os.path.join(annotations_dir, annotations_corrected_file + '_exp_0002_corrected.json')
