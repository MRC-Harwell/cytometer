...
The hand traced data set, colour maps, and automatic segmentations were generated by the experiments of project cytometer (https://github.com/MRC-Harwell/cytometer), and used for the paper:
